function SelectTicket() {
    return (
      <div className="w-full h-[1126px] flex flex-col bg-[#02191D] bg-opacity-40 items-center overflow-hidden ">
        <div className="max-w-full w-[900px] px-5">
          {/* Navigation Bar */}
          <div className="w-full h-[76px] bg-[#24A0B533]/20 border-1 rounded-3xl px-[10px] mt-[12px] border-[#197686] flex">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="text-white font-bold text-xl  ">
                  <a href="#">
                      ...
                      {/* logo */}
                      <div data-svg-wrapper data-layer="Frame 1618871078" class="Frame1618871078" >
  ...
  <path d="M17 9.5V26.5M10.464 15.344C10.216 15.344 9.98902 15.142 10 14.879C10.067 13.337 10.255 12.333 10.78 11.539C11.0795 11.0865 11.455 10.6893 11.89 10.365C13.055 9.5 14.7 9.5 17.992 9.5H22.006C25.298 9.5 26.943 9.5 28.11 10.365C28.541 10.685 28.917 11.082 29.219 11.539C29.744 12.333 29.932 13.337 29.999 14.879C30.01 15.142 29.783 15.344 29.534 15.344C28.148 15.344 27.024 16.533 27.024 18C27.024 19.467 28.148 20.656 29.534 20.656C29.783 20.656 30.01 20.858 29.999 21.122C29.932 22.663 29.744 23.667 29.219 24.462C28.9195 24.9141 28.5439 25.311 28.109 25.635C26.943 26.5 25.298 26.5 22.006 26.5H17.993C14.701 26.5 13.056 26.5 11.889 25.635C11.4544 25.3106 11.0792 24.9134 10.78 24.461C10.255 23.667 10.067 22.663 10 21.121C9.98902 20.858 10.216 20.656 10.464 20.656C11.85 20.656 12.974 19.467 12.974 18C12.974 16.533 11.85 15.344 10.464 15.344Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <mask id="path-3-outside-1_4003_336" maskUnits="userSpaceOnUse" x="46" y="4.688" width="47" height="26" fill="black">
  ...
  <path d="M83.3448 28.672L81.4888 25.888C81.8088 25.3547 82.2568 24.6507 82.8328 23.776C83.4301 22.9013 84.0594 21.9733 84.7208 20.992C85.4034 19.9893 86.0434 19.04 86.6408 18.144C87.2594 17.248 87.7501 16.5227 88.1128 15.968H87.5688C86.5234 15.968 85.6914 16.032 85.0728 16.16C84.4754 16.288 83.9848 16.5227 83.6008 16.864H83.0568L81.1048 13.984L81.3608 13.44H89.1688L91.2488 16.288C91.0568 16.608 90.7581 17.0773 90.3528 17.696C89.9688 18.3147 89.5208 19.0187 89.0088 19.808C88.5181 20.576 88.0061 21.3653 87.4728 22.176C86.9608 22.9653 86.4701 23.712 86.0008 24.416C85.5528 25.0987 85.1901 25.664 84.9128 26.112H85.1048C85.7234 26.1333 86.5021 26.1333 87.4408 26.112C88.4008 26.0693 89.3394 25.9733 90.2568 25.824L91.7928 28.128L91.5368 28.672H83.3448Z" stroke="white" stroke-width="2" mask="url(#path-3-outside-1_4003_336)"/>
               ...
               <p className='text-black bg-amber-50 p-2 rounded-xl'>My Tickets</p>
               </div>
              </div>
            </nav>
          </div>
        ...
        <div className="md:w-[700px] w-[350px] h-[1271px]  md:h-[858px] rounded-[40px] border-1 pt-[20px] md:pt-[64px] md:p-[40px]   gap-[32px] bg-[#041E23] border-[#0E464F] md:mt-[50px] mt-[20px]">
...
<div className="text-neutral-50 text-base font-normal font-['Roboto'] leading-normal mt-[30px]"> Number of Tickets
...
<div className="h-12 w-full mt-[30px] justify-end items-end gap-6 inline-flex">
  ...
  <div className="grow shrink basis-0 h-12 px-6 py-3 bg-[#23a0b5] rounded-lg justify-center items-center gap-2 flex overflow-hidden">
    <div className="text-white text-base font-normal font-['JejuMyeongjo'] leading-normal">Next</div>
  </div>
</div>
