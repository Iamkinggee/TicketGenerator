...
//                 <div  >                    
//                 <button type="submit"   className="grow shrink basis-0 md:h-12 md:px-6 py-3 rounded-lg border border-[#23a0b5] justify-center items-center gap-2 flex  w-[340px] h-[48px] bg-[#23a0b5] "  >Next
