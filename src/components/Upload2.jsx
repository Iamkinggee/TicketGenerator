...
//     const allowedFileSize = 400 * 1024;
...
const Upload2 = () => {
    ...
    const handleFileChange = ({ e, dropped = false }) => {
        ...
        try {
            ...
            axios.post(`https://api.cloudinary.com/v1_1/${cloud_name}/images/upload`, formData, { // Correct endpoint
    ...
    return (
        <div className='upload-container'>
            <input ref={fileRef} id='file_upload_btn' type='file' hidden onChange={(e) => handleFileChange({ e })} />
            <label htmlFor='file_upload_btn' onDrop={handleDrop} onDragOver={handleDragOver} className='upload-label'>
                {/* Upload UI code here */}


                <div className='border-2 border-dotted border-indigo-500 w-[250px] flex flex-col gap-2 items-center justify-center p-4 rounded-md'>
            <svg className='w-5' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M12 15L12 2M12 2L15 5.5M12 2L9 5.5" stroke="#1C274C" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M8 22.0002H16C18.8284 22.0002 20.2426 22.0002 21.1213 21.1215C22 20.2429 22 18.8286 22 16.0002V15.0002C22 12.1718 22 10.7576 21.1213 9.8789C20.3529 9.11051 19.175 9.01406 17 9.00195M7 9.00195C4.82497 9.01406 3.64706 9.11051 2.87868 9.87889C2 10.7576 2 12.1718 2 15.0002L2 16.0002C2 18.8286 2 20.2429 2.87868 21.1215C3.17848 21.4213 3.54062 21.6188 4 21.749" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"></path> </g></svg>             {file?.name.substring(0, 16)}{file?.name.length > 16 && `.${file?.name.split('.')[1]}`}             <p className='text-indigo-600'>Upload a File</p>
            </div>
            </label>
